...
from dielectric_models import TL_multi
...
def RT_TL(lam_vac, params, args):
    ...
    return R, T
def RT_rough_TL(lam_vac, params, args):
...
def SE_TL(lam_vac, theta, params, args):
...
def SE_rough_TL(lam_vac, theta, params, args):
...
def error_RT(params, *args):
    ...
    model_values = np.array([RT_TL(lam_vac, params, (n_osz, d_s_RT,
                                                     theta_0_T, theta_0_R,
...
def error_SE(params, *args):
    ...
    for theta in theta_values:
        ...
        psi_values, delta_values = np.array([SE_rough_TL(lam_vac, theta, params, (n_osz, subs)) for lam_vac in lam_vac_SE]).T
